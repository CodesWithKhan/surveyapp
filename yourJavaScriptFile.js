    ...
    nextButton.addEventListener("click", () => {
        ...
        if (currentQuestion >= currentSectionData.questions.length) {
            if (currentSection === sections.length - 1) {
                ...
                goToNextSectionButton.textContent = "Go to Next Section";
...
function displayFinalResult(questionContainer) {
    ...
    // Calculate the final score and round it to an integer
    const finalScore = Math.round((sectionScores.reduce((acc, score) => acc + score, 100) / 1000) * 1000);
